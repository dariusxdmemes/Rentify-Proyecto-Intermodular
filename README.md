# Rentify-Proyecto-Intermodular
## Descripción del proyecto
Proyecto desarrollado en clase de una aplicación de gestion de alquileres 
...
en adelante "arrandatarios".
 ...
 de identificación (_email_, _contraseña_).

 ## Identificación como _arrendador_
 Si el usuario es un arrendador y se identifica como tal, la pantalla principal mostrará
...
### Pantalla inicial:
 ...
 - Precio mensual.
 - _amenities_ incluidas y no incluidas (luz, plaza de garaje, agua...).

## Incidencias como arrendador
...
## Opciones/_settings_ como arrendador
...
## Identificación como arrendatario
Si el usuario es un arrendatario y se identifica como tal, la pantalla principal mostrará
...
- _amenities_ incluídas del inmueble (luz, plaza de garaje, agua...).
- Teléfonos de interés (electricista, fontanería, etc.) _los añade el arrenador si así lo considera._
